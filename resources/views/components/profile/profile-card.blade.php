<div x-data="{saveProfile(){
        ...
        <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
            <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
                <div class="h-20 w-20 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800 flex items-center justify-center bg-white/10">
                    <svg class="w-10 h-10 text-gray-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <div class="order-3 xl:order-2">
                    ...
                    <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ optional(auth()->user()->division)->name ?? 'Sipovinus Team' }}
                        </p>
                    </div>
                </div>
                <div class="order-2 flex grow items-center gap-2 xl:order-3 xl:justify-end"></div>
            </div>
    ...
    <x-ui.modal x-data="{ open: false }" @open-profile-info-modal.window="open = true" :isOpen="false" class="max-w-[600px]">
        <div class="no-scrollbar relative w-full max-w-[600px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-8">
            <div class="px-2 pr-14">
                ...
                <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">
                    Update your details to keep your account information up-to-date.
                </p>
            </div>
            ...
            <form id="profile-update-form" class="flex flex-col" method="POST" action="{{ route('profile.update') }}">
                ...
                <div class="p-2 space-y-5">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ auth()->user()->name }}" required
                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:outline-hidden dark:border-gray-700 dark:text-white/90" />
                    </div>
                ...
                <div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
                    ...
                    <button @click="saveProfile" type="button"
                        class="flex w-full justify-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700 sm:w-auto transition">
                        Save Changes
                    </button>
                </div>
            </form>
