                            ...
                            <div class="space-y-5">
                                ...
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    <div class="sm:col-span-2">
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            Division<span class="text-error-500">*</span>
                                        </label>
                                ...
                                <div>
                                    <div x-data="{ checkboxToggle: false }">
                                        <label for="checkboxLabelOne" class="flex cursor-pointer items-start text-sm font-normal text-gray-700 select-none dark:text-gray-400">
                                            <div class="relative">
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <p class="text-3xl font-bold text-white mb-2 tracking-wide">Sipovinus</p>
                        <p class="text-center text-gray-400 dark:text-white/60 text-sm">
                            Sistem Manajemen Informasi & Monitoring Program Kerja Berbasis Digital
                        </p>
                    </div>
                </div>
            </div>
