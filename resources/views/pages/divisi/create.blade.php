...
<div class="grid grid-cols-12 gap-4 md:gap-6">
  <div class="col-span-12 md:col-span-8">
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
      <h2 class="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Tambah Divisi</h2>

      <form action="{{ route('manajemen-divisi.store') }}" method="POST">
        @csrf
        ...
        <div class="flex gap-4">
          ...
          <button type="submit" class="inline-block rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">Simpan</button>
        </div>
      </form>
    </div>
  </div>
